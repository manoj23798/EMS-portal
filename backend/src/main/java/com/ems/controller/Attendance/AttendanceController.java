package com.ems.controller.Attendance;
...
public class AttendanceController {
    ...
    public ResponseEntity<AttendanceResponse> startBreak(
            @RequestParam("employeeId") Long employeeId,
            @RequestParam("breakType") String breakType) {
        return ResponseEntity.ok(attendanceService.startBreak(employeeId, breakType));
    }
