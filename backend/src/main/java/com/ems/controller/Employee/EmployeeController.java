...
import com.ems.repository.Employee.EmployeeDocumentRepository;
...
public class EmployeeController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<EmployeeResponse>> searchEmployees(@RequestParam("query") String query) {
